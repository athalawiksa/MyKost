...
if ($redirect) {
    header("Location: griyatara2.php");
    exit;
}

// Set the kost name for this page
$nama_kost = 'Griya Tara 2';
...
<head>
    ...
    <title>MyKost: Griya Tara 2</title>
            ...
            <div class="modal fade" id="addKostModal" tabindex="-1" aria-labelledby="addKostModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- Form pengisian -->
                            <form method="post" action="griyatara2.php" id="addKostForm" enctype="multipart/form-data">
            ...
            <div class="modal fade" id="editKostModal" tabindex="-1" aria-labelledby="editKostModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- Form edit data -->
                            <form method="post" action="griyatara2.php" id="editKostForm" enctype="multipart/form-data">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <a href="griyatara2.php?delete=<?php echo $kost['id']; ?>" 
