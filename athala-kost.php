...
if ($redirect) {
    header("Location: athala-kost.php");
    exit;
}

// Set the kost name for this page
$nama_kost = 'Athala Kost';
...
<head>
    ...
    <title>MyKost: Athala Kost</title>
            ...
            <div class="modal fade" id="addKostModal" tabindex="-1" aria-labelledby="addKostModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- Form pengisian -->
                            <form method="post" action="athala-kost.php" id="addKostForm" enctype="multipart/form-data">
            ...
            <div class="modal fade" id="editKostModal" tabindex="-1" aria-labelledby="editKostModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- Form edit data -->
                            <form method="post" action="athala-kost.php" id="editKostForm" enctype="multipart/form-data">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <a href="athala-kost.php?delete=<?php echo $kost['id']; ?>" 
