...
// Get all data without filtering for client-side search
$stmt = $pdo->query("SELECT * FROM data_kamar ORDER BY id DESC");
...
<body>
    ...
    <div class="modal-body">
        <div class="container-fluid">
                            ...
                            <form method="post" action="datakamar.php" id="addKamarForm" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="nama_kost" name="nama_kost" required>
                                        ...
                                        <option value="Griya Tara 1">Griya Tara 1</option>
                                    </select>
                                </div>
                                <div class="mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="search-box">
                        ...
                        <input type="text" id="searchInput" placeholder="Cari data kamar...">
                    </div>
                </div>
            </div>

            <div class="table-responsive">
                <table class="table table-bordered table-hover" id="dataKamarTable">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama Kost</th>
            ...
            <div class="row">
                <div class="col-md-6">
                    <p id="showing-entries">Showing <?php echo count($data_kamar) > $limit ? $limit : count($data_kamar); ?> of <?php echo $total_rows; ?> entries</p>
                </div>
            </div>
        </div>
    </div>
...
<script>
// JavaScript for handling the edit modal and search functionality
document.addEventListener('DOMContentLoaded', function() {
    ...
    const table = document.getElementById('dataKamarTable');
    const tableRows = table.querySelectorAll('tbody tr');
    const showingEntriesText = document.getElementById('showing-entries');
    ...
    function filterTable() {
        ...
        showingEntriesText.textContent = `Showing ${visibleRowsCount} of ${tableRows.length} entries`;
        
        // Show "no results" message if no matches
        if (visibleRowsCount === 0 && searchText !== '') {
            if (!document.querySelector('.no-results-row')) {
                const noResultsRow = document.createElement('tr');
                noResultsRow.className = 'no-results-row';
                const noResultsCell = document.createElement('td');
                noResultsCell.colSpan = 6;
                noResultsCell.className = 'no-records';
                noResultsCell.innerHTML = '<i class="bi bi-info-circle me-2"></i>Tidak ada data yang cocok dengan pencarian';
